...
async def errors_handler(event: ErrorEvent, bot: Bot, config: Config) -> bool:
    ...
    :param event: The ErrorEvent object containing the exception and update.
    :param bot: The Bot instance for sending messages.
    :param config: The Config instance containing bot configuration.
    :return: True to stop further error handling, False to continue.
    """
